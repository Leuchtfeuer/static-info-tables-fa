<?php
namespace SJBR\StaticInfoTablesFa;
...
class ext_update
{
	...
	public function main()
	{
		...
		$databaseUpdateUtility->doUpdate('static_info_tables_fa');

		$content.= '<p>' . LocalizationUtility::translate('updateLanguageLabels', 'StaticInfoTables') . ' static_info_tables_fa.</p>';
		return $content;
	}
