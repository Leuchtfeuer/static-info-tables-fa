...
class ext_update  {
	...
	function main()	{
		...
		if (t3lib_div::_GP('import')) {
			...
			$extPath = t3lib_extMgm::extPath('static_info_tables_fa');
		...
		} elseif (t3lib_extMgm::isLoaded('static_info_tables_fa')) {
...
// Include extension?
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/static_info_tables_fa/class.ext_update.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/static_info_tables_fa/class.ext_update.php']);
}
